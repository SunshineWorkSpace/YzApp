...
/**
 * 类名称:ConsumerPriceSubmitActivity
 * 类描述:消保金付款页面
 * 创建时间: 2018-11-10-02:15
 * 创建人: sht
 * 修改人: sht
 * 修改备注:
 */
public class ConsumerPriceSubmitActivity extends BaseActivity {
    ...
    private void doAlipay(final JSONObject aliObject) {
        ...
        Runnable payRunnable = new Runnable() {
            @Override
            public void run() {
                PayTask alipay = new PayTask(ConsumerPriceSubmitActivity.this);
