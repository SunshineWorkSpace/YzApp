...
/**
 * 类名称:MallOrderBuyPayActivity
 * 类描述:商品购物订单
 * 创建时间: 2018-11-12-16:45
 * 创建人: sht
 * 修改人: sht
 * 修改备注:
 */
public class MallOrderBuyPayActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setActivityTitle("商品购物订单");
        ((TextView)findViewById(R.id.authmoney_tv_title)).setText("商品购物订单");
    ...
    private void doAlipay(final JSONObject aliObject) {
        ...
        Runnable payRunnable = new Runnable() {
            @Override
            public void run() {
                PayTask alipay = new PayTask(MallOrderBuyPayActivity.this);
