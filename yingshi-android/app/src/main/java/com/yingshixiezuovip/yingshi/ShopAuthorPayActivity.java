...
/**
 * 类名称:ShopAuthorPayActivity
 * 类描述:商铺认证
 * 创建时间: 2018-11-13-23:30
 * 创建人: sht
 * 修改人: sht
 * 修改备注:
 */
public class ShopAuthorPayActivity extends BaseActivity {
    ...
    private void payMoneyDate() {
        ...
        orderParams.put("major", getIntent().getStringExtra("major"));
        orderParams.put("city", getIntent().getStringExtra("city"));
        orderParams.put("birth", getIntent().getStringExtra("birth"));
        orderParams.put("shoptype", getIntent().getStringExtra("shoptype"));
        orderParams.put("constansphone", getIntent().getStringExtra("constansphone"));
        orderParams.put("identity_card", getIntent().getStringExtra("identity_card"));
        orderParams.put("side_card", getIntent().getStringExtra("side_card"));
        orderParams.put("license", getIntent().getStringExtra("license"));
        orderParams.put("price", getIntent().getStringExtra("price"));
        orderParams.put("unit", getIntent().getStringExtra("unit"));
    ...
    private void doAlipay(final JSONObject aliObject) {
        ...
        Runnable payRunnable = new Runnable() {
            @Override
            public void run() {
                PayTask alipay = new PayTask(ShopAuthorPayActivity.this);
    ...
    public String getCallbackURL() {
        String callBack;
        callBack = "/shopAuthCallback/zhifubaocallback.spr";
