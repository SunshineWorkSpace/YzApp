...
public class GifView extends View {
    private static final int DEFAULT_MOVIE_DURATION = 1500;
     ...
     * @param moviePath
     */
    public void setMovieResource(String moviePath) throws FileNotFoundException {
        repeatCount = 0;
        mMovie = Movie.decodeStream(new FileInputStream(new File(moviePath)));
        requestLayout();
    }
    ...
    private void updateAnimationTime() {
        ...
        if (dur - mCurrentAnimationTime <= 20) {  //GPU 绘制周期
            repeatCount++;

            if (onRepeatListener != null) {
                onRepeatListener.onRepeat(repeatCount);
            }
        }
    }
