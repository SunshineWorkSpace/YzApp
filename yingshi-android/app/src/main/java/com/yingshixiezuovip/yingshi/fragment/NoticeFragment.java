...
public class NoticeFragment extends BaseFragment implements OnAdapterClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return View.inflate(getActivity(), R.layout.fragment_notice, null);
    }
    ...
    private PullToRefreshBase.OnRefreshListener2 onRefreshListener = new PullToRefreshBase.OnRefreshListener2() {
        ...
        public void onPullDownToRefresh(PullToRefreshBase refreshView) {
            ...
            SPUtils.saveRefreshTime(getActivity(), "consult", currentTime);
            mPage = 0;
