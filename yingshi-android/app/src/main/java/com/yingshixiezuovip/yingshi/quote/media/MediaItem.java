...
public class MediaItem implements Parcelable {
    ...
    private DetailsEditModel.DataBean.BodylistBean listBean;
    ...
    public DetailsEditModel.DataBean.BodylistBean getListBean() {
        return listBean;
    }

    public void setListBean(DetailsEditModel.DataBean.BodylistBean listBean) {
