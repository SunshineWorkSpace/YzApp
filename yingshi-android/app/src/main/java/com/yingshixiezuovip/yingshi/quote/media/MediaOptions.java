...
public class MediaOptions implements Parcelable {
    ...
    public int getMaxSeletePhoto() {
        return maxSelectPhoto;
    }
    ...
    private MediaOptions(Builder builder) {
        ...
        this.maxSelectPhoto = builder.maxSelectPhoto;
    ...
    public static class Builder {
        ...
        public Builder setMaxSelectPhoto(int maxSelect) {
            this.maxSelectPhoto = maxSelect;
            return this;
        }
    ...
    public MediaOptions(Parcel in) {
        ...
        this.maxSelectPhoto = in.readInt();
    }
