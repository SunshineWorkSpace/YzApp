...
import com.yingshixiezuovip.yingshi.quote.media.CropListener;
import com.yingshixiezuovip.yingshi.quote.media.MediaItem;
import com.yingshixiezuovip.yingshi.quote.media.MediaOptions;
import com.yingshixiezuovip.yingshi.quote.media.MediaSelectedListener;
import com.yingshixiezuovip.yingshi.quote.media.imageloader.MediaImageLoader;
import com.yingshixiezuovip.yingshi.quote.media.imageloader.MediaImageLoaderImpl;
import com.yingshixiezuovip.yingshi.quote.media.utils.MediaUtils;
import com.yingshixiezuovip.yingshi.quote.media.utils.MessageUtils;
import com.yingshixiezuovip.yingshi.quote.media.utils.RecursiveFileObserver;
...
public class MediaPickerActivity extends BaseActivity implements
     ...
     * @param options
     */
    public static void open(BaseActivity activity, int requestCode,
                            MediaOptions options) {
        Intent intent = new Intent(activity, MediaPickerActivity.class);
        intent.putExtra(EXTRA_MEDIA_OPTIONS, options);
        activity.startMActivityForResult(intent, requestCode);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.right_btn_name)).setText("确定");
        findViewById(R.id.right_btn_submit).setOnClickListener(this);
        setActivityTitle(mMediaOptions.canSelectVideo() ? "选择视频" : "选择图片");
    }
    ...
    public void syncActionbar() {
        ...
        if (fragment instanceof PhotoCropFragment) {
            ...
            findViewById(R.id.right_btn_submit).setVisibility((pickerFragment.hasMediaSelected() ? View.VISIBLE : View.GONE));
        }
    }
    ...
    private boolean hasCameraPermission() {
        return CommUtils.cameraIsCanUse();
    }
