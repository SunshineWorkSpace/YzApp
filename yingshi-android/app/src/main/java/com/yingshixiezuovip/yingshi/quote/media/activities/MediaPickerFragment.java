...
import com.yingshixiezuovip.yingshi.quote.media.widget.HeaderGridView;
import com.yingshixiezuovip.yingshi.quote.media.widget.PickerImageView;
...
public class MediaPickerFragment extends BaseFragment implements
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
                            long id) {
        if (mMediaOptions.canSelectPhoto() && mMediaSelectedList != null && mMediaOptions.getMaxSeletePhoto() != -1 && mMediaSelectedList.size() >= mMediaOptions.getMaxSeletePhoto()) {
            ToastUtils.showMessage(getActivity(), "最多只能选择" + mMediaOptions.getMaxSeletePhoto() + "张图片");
            return;
        }
