...
public class MoneyUtil {
     ...
     * @return
     */
    public static String moneyMul2(String valueStr,String divideStr){
        BigDecimal value = new BigDecimal(valueStr);
        BigDecimal divideValue = new BigDecimal(divideStr);
        String money=fnum.format(value.multiply(divideValue).
                setScale(2,BigDecimal.ROUND_HALF_UP));
        BigDecimal value2 = new BigDecimal(money);
        DecimalFormat fnum2 = new DecimalFormat("##0.00");
        return fnum2.format(value2);
    }
    /**
     * 金额相除 <br/>
     * 精确小位小数
